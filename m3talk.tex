...
\begin{tikzpicture}[scale = 1.07, transform shape, draw=black, fill=black, very thick, sloped]
	...
	\draw[rounded corners=-1.5mm]  (1.5,-2.25) rectangle (8,2.25); 
	 ...
	 \draw[thin,dashed] (3.5,0) circle (0.4); 
	 \draw[thin,dashed] (3.7,0) circle (0.6); 
%	   \draw[thin,dashed] (3.9,0) circle (0.8); 
	  \draw[thin,dashed] (4.1,0) circle (1); 
%	 \draw[thin,dashed] (4.3,0) circle (1.2); 
	  \draw[thin,dashed] (4.5,0) circle (1.4); 
