...
%	  \draw[thin,dashed,draw=colO] (3.5,0) circle (1.4); 
	 ...
	 \draw[thin,dashed,draw=colO] (2.5,0) circle (0.4 and 1.2); 
	 \draw[thin,dashed,draw=colO] (2.6,0) circle (0.6 and 1.44); 
	  \draw[thin,dashed,draw=colO] (2.8,0) circle (0.9 and 1.73); 
	  \draw[thin,dashed,draw=colO] (3.2,0) circle (1.35 and 2.07);
	  
	\draw[dashed, decoration=snake, decorate,draw=colG] (1.4,-1) -- (8.1,-0.6);
	\draw[dashed, decoration=snake, decorate,draw=colG] (1.4, 1) -- (8.1,0.6);
