...
The path-strings of $t=\mh(\mf(\ma,y))$ are 
\EMPH{$\epsilon.\mh.1.\mf.1.\ma$} and 
\EMPH{$\epsilon.\mh.1.\mf.1.2.*$}:
\vspace{0.7em}
...
\node (h1f1a) at (2*\dx,-2.8) {.};
\node (h1f2) at (2*\dx+\wx,-2.1) {.};
\node (h1f2x) at (2*\dx+\wx,-2.8) {.};
